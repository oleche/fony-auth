...
class UserPut
{
    ...
    private function updateUser()
    {
        ...
        $this->user->columns['lastname'] = (isset($_POST['lastname'])) ?
            $_POST['lastname'] : $this->user->columns['lastname'];
    ...
    {
        if (!AllowCore::isAllowed($this->session->session_scopes, $this->validScope)) {
